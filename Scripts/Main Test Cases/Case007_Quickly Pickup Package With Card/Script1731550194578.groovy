...
WebUI.click(findTestObject('Object Repository/QuickReceive Page/div_Card'), FailureHandling.CONTINUE_ON_FAILURE)
...
'快速領取'
WebUI.click(findTestObject('Object Repository/QuickReceive Page/Pickup Package Page/span_SelectAll'))

WebUI.click(findTestObject('Object Repository/QuickReceive Page/Pickup Package Page/span_SelectFirst'))
