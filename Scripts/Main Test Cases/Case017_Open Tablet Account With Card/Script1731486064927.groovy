...
'選擇開通方式'
WebUI.click(findTestObject('Object Repository/Page_Tablet/Activate Pages/div_Card'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('C:\\AutoTest-MGMT (Screenshoot)\\Case17 能用門禁卡完成裝置開通戶別\\門禁卡感應.png')

WebUI.setText(findTestObject('Object Repository/Page_Tablet/Activate Pages/input_CardToken'), '0260002005')

WebUI.sendKeys(findTestObject('Object Repository/Page_Tablet/Activate Pages/input_CardToken'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('C:\\AutoTest-MGMT (Screenshoot)\\Case17 能用門禁卡完成裝置開通戶別\\門禁卡開通戶別.png')