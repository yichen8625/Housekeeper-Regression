...
WebUI.click(findTestObject('Object Repository/receive packages/type_barcode'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/receive packages/input_token'), code)

WebUI.sendKeys(findTestObject('Object Repository/receive packages/input_token'), Keys.chord(Keys.ENTER))
