...
WebUI.click(findTestObject('Object Repository/table/package/receive packages/wrap_barcode'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/table/package/receive packages/input_token-barcode'), code)

WebUI.sendKeys(findTestObject('Object Repository/table/package/receive packages/input_token-barcode'), Keys.chord(Keys.ENTER))
