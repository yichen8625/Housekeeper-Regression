...
'寄放領取'
//Step2. 選擇戶別
WebUI.click(findTestObject("Object Repository/receive things/type_card"))

WebUI.setText(findTestObject('Object Repository/receive things/input_token_c'), code)

WebUI.delay(3)

WebUI.sendKeys(findTestObject('Object Repository/receive things/input_token_c'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/receive things/buttton_confirm'), FailureHandling.CONTINUE_ON_FAILURE)
'選取包裹'
//Step3. 確認細項
WebUI.scrollToElement(findTestObject('Object Repository/receive things/title_list'), 1)
...
WebUI.delay(3)
//截圖路徑
WebUI.takeFullPageScreenshot('C:\\Users\\noahc\\Katalon Studio\\Sprint3-housekeeper (Noah) 2.0\\ScreenShoot\\card receive things.png')
