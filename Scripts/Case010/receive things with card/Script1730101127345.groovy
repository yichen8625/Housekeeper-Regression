...
'寄放領取'
//Step2. 選擇戶別
WebUI.click(findTestObject("Object Repository/receive items/type_card"))

WebUI.setText(findTestObject('Object Repository/receive items/input_token_c'), code)

WebUI.waitForPageLoad(5)

WebUI.sendKeys(findTestObject('Object Repository/receive items/input_token_c'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/receive items/buttton_confirm'), FailureHandling.CONTINUE_ON_FAILURE)
'選取包裹'
//Step3. 確認細項
WebUI.scrollToElement(findTestObject('Object Repository/receive items/title_list'), 1)
