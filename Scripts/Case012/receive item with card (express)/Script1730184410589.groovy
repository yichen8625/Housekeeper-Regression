...
'寄放領取'
//Step2. 選擇戶別
WebUI.click(findTestObject("Object Repository/quick receive/wrap_card"))
...
'寄放tab'
WebUI.click(findTestObject('Object Repository/quick receive/receive-item/tab_item'))

WebUI.delay(3)

'選取寄放物品'
//Step3. 確認細項
WebUI.click(findTestObject("Object Repository/quick receive/receive-item/checkbox_list"))
