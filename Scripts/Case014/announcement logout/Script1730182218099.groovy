...
'新增公告'
WebUI.click(findTestObject('Object Repository/table/announcement/btn_add'))

'展開列表'
WebUI.click(findTestObject("Object Repository/table/header/btn_logininfo-announcement"))

WebUI.delay(3)

WebUI.takeFullPageScreenshot('C:\\AutoTest-MGMT (Screenshoot)\\Case14 能從公告列表頁完成登出\\登出前.png')

WebUI.click(findTestObject("Object Repository/table/header/btn_logout-announcement"))
